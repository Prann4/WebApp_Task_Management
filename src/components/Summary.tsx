...
const Summary: React.FC<Props> = ({ tasks, setView }) => {
  ...
  return (
    <section>
      ...
      <div className="w-full max-w-3xl !mb-6 p-12 text-white bg-teal-500 rounded-lg font-bold text-4xl flex items-center">
      ...
      <div className="w-full max-w-3xl !mb-12">
        <div className="p-12 text-white bg-teal-500 bg-opacity-90 rounded-lg font-bold text-4xl flex items-center">
          <span className="text-5xl mr-6">☰</span>
      ...
      <div className="w-full max-w-3xl flex justify-between items-start !gap-x-30">
        <button
